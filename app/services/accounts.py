        ...
        with db_connection() as conn:
            with conn.cursor() as cursor:
                ...
                for column_def in (
                    ...
                    "email_confirmation_reminder_sent_at TEXT",
...
def normalize_account_row(row) -> dict | None:
    ...
    return {
        ...
        "email_confirmation_reminder_sent_at": row["email_confirmation_reminder_sent_at"] if "email_confirmation_reminder_sent_at" in row.keys() else None,
